...
namespace GPLVM.Numerical
{
    ...
    public class OptimizationProgressEventArgs : EventArgs
    {
        ...
        /// </summary>
        /// 
        public ILArray<double> Gradient { get; set; }
        ...
        /// </summary>
        /// 
        public ILArray<double> Solution { get; set; }
        ...
        public OptimizationProgressEventArgs(
            ...
            ILArray<double> gradient, double gnorm,
            ILArray<double> solution, double xnorm,
            double value, double stp, bool finished)
        {
            this.Gradient = gradient.C;
