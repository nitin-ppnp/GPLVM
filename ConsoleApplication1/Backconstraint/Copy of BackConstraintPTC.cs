...
{
    public class tmpBackConstraintPTC : IBackconstraint
    {
        private int _N;
        private int _q;
        private int _D;
        ...
        private ILArray<double> _K1; // cosine phase kernel for dimension 1
        private ILArray<double> _K2; // sine phase kernel for dimension 2
        private ILArray<double> _K3; // Euclidean distance for the rest dimensions
        private ILArray<double> _invK1;
        private ILArray<double> _invK2;
        private ILArray<double> _invK3;

        private ILArray<double> _phase;
        ...
        /// </remarks>  
        public tmpBackConstraintPTC()
        {
            //_type = BackConstType.tmp;
        ...
        public ILRetArray<double> BackConstraintsGradient(ILInArray<double> ingX)
        {
            using (ILScope.Enter(ingX))
            {
                ...
                ILArray<double> gAtmp = ILMath.zeros(gX.Size);
                ...
                //if (_X.S[1] > 2)
                //    gAtmp[ILMath.full, ILMath.r(2, ILMath.end)] = ILMath.multiply(_K3, gX[ILMath.full, ILMath.r(2, ILMath.end)]);
        ...
        private void CreatePhase()
        {
            ...
            if (numSeg > 1)
            {
                ...
                for (int i = 1; i < numSeg; i++)
                {
                    ...
                    offStep[i] = (idx - 1) * offStep[numSeg]; // applying the angles
            ...
            _phase = ILMath.zeros(_Y.Size[0], 1);
